            ...
            <ul class="nav">
                ...
                if (sizeOf($results) <= 5) {
                    foreach ($results as $row) {
                        ...
                        echo '<a href="../post/ListPost.php?categoria_id=' . $row['categoria_id'] . '"> ' . $row['name'] . '</a>';
                    ...
                    for ($i = 0; $i <= 4; $i++) {
                        ...
                        $row = $results[$i];
                        echo '<li class="nav-item col-2 mt-2">';
                        echo '<a  href="../post/ListPost.php?categoria_id=' . $row['categoria_id'] . '">Categoria ' . $row['categoria_id'] . '</a>';
                        // echo '<button class="buttonHeader" onclick="window.location.href="./ListCategoria.php?id' . $row['categoria_id'] . '">Categoria ' . $row['categoria_id'] . '</button>';
                        echo '</li>';
                    }
        ...
        <table class="table" style="text-align: center;">
            ...
            <tbody>
                ...
                foreach ($results as $row) {
                    ...
                    echo '<td width=250>';
                    echo '<a class="btn btn-dark" href="ListPost.php?id=' . $row['categoria_id'] . '">Ver Posts</a>';
